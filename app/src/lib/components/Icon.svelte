<script lang="ts">
  ...
  const paths: Record<string, string> = {
    ...
    bell: "M18 15v-4a6 6 0 0 0-12 0v4l-2 3h16z M9.5 21a2.5 2.5 0 0 0 5 0",
    fan: "M12 13.6a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2z M12 10.4c0-3 1.3-5.6 3-5.6 1.4 0 1 3.6-3 5.6 M12 13.6c0 3-1.3 5.6-3 5.6-1.4 0-1-3.6 3-5.6 M10.4 12c-3 0-5.6-1.3-5.6-3 0-1.4 3.6-1 5.6 3 M13.6 12c3 0 5.6 1.3 5.6 3 0 1.4-3.6 1-5.6-3",
    // power modes
